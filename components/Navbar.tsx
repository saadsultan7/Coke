    ...
    return (
        ...
        >
            <div className="container mx-auto px-6 flex justify-between items-center">
                ...
                <button className="px-6 py-2 bg-red-600 hover:bg-red-700 text-white text-xs font-bold uppercase tracking-widest rounded-full transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(220,38,38,0.4)]">
                    Order Now
                </button>
            </div>
        </motion.nav>
